...
void modalButtons(BuildContext context, String title, String message,
    String okText, Function fn, IconData icon,
  ...
  Dialogs.materialDialog(
      ...
      actions: [
        ...
        IconsButton(
          ...
          text: okText,
          iconData: icon,
          color: const Color.fromARGB(255, 165, 14, 14),
...
void modalButtonsDelete(BuildContext context, String title, String message,
    String okText, Function fn, IconData icon,
    {bool dismissible = true}) {
  Dialogs.materialDialog(
      msg: message,
